...
class Superadmin extends CI_Controller {
    ...
    /*     * *default functin, redirects to login page if no superadmin logged in yet** */
    ...
    function dashboard() {
        ...
        $page_data['page_title'] = translate('superadmin_dashboard');
	...
	function control_setup()
	{
		if ($this->session->userdata('superadmin_login') != 1)
            redirect(base_url(), 'refresh');
		$count=get_single_value('count(controls_id)','controls');
		if($count)
		$this->gc->unset_add();
		$this->gc
		->set_table('controls')
		->set_subject(translate('control'));
		$output=$this->gc->render();
        $page_data['page_name'] = 'output';
        $page_data['page_title'] = translate('manage_control');
	...
	function student_add($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?superadmin/student_add/', 'refresh');
        }
    ...
    function parent($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?superadmin/parent/' . $class_id, 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name'] = $this->input->post('name');
            $data['email'] = $this->input->post('email');
            ...
            redirect(base_url() . 'index.php?superadmin/parent/' . $param3, 'refresh');
        } else if ($param1 == 'edit') {
    ...
    function subject($param1 = '', $param2 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?superadmin/subject/', 'refresh');
        }
        if ($param1 == 'do_update') {
		    $forthchk = $this->input->post('fourthsub');
            $data['name'] = $this->input->post('name');
    ...
    function classes($param1 = '', $param2 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?superadmin/classes/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name'] = $this->input->post('name');
            $data['name_numeric'] = $this->input->post('name_numeric');
    ...
    function exam($param1 = '', $param2 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?superadmin/exam/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name'] = $this->input->post('name');
            $data['date'] = $this->input->post('date');
    ...
    function marks($exam_id = '', $class_id = '', $subject_id = '' , $sub_exam_id = '', $group_name = '') {
		...
		$page_data['sub_exam_id']=99999;
            if ($page_data['exam_id'] > 0 && $page_data['class_id'] > 0 && $page_data['subject_id'] > 0 ) {
                redirect(base_url() . 'index.php?superadmin/marks/' . $page_data['exam_id'] . '/' . $page_data['class_id'] . '/' . $page_data['subject_id'] . '/' . $page_data['sub_exam_id'].'/' . $page_data['group_name'], 'refresh');
            }else {
                $this->session->set_flashdata('mark_message', 'Choose exam, class and subject');
                redirect(base_url() . 'index.php?superadmin/marks/', 'refresh');
            }
        }
        if ($this->input->post('operation') == 'update') {
            ...
            redirect(base_url() . 'index.php?superadmin/marks/' . $this->input->post('exam_id') . '/' . $this->input->post('class_id') . '/' . $this->input->post('subject_id') . '/'.  $this->input->post('exam_sub_id').'/' . $this->input->post('group_name')  , 'refresh');
        }
        ...
        $this->load->view('superadmin/marks', $page_data);
    }
	function marks_input_sheet($exam_id = '', $class_id = '', $subject_id = '' , $sub_exam_id = '', $group_name = '') {
        ...
        $page_data['page_title'] = translate('manage_exam_marks');
		$page_data['system_title'] = "Powered By Wemax Software Ltd.";
        $this->load->view('superadmin/marks_input_sheet', $page_data);
    }
    function manage_attendance($class_id,$exam_id,$sub_exam_id='',$group_id='')
	{
        ...
        $this->load->view('superadmin/manage_attendance', $page_data);
	}
    function full_mark()
	{
		$condition=array(
		...
		redirect(base_url() . 'index.php?superadmin/marks/' . $this->input->post('exam_id') . '/' . $this->input->post('class_id') . '/' . $this->input->post('subject_id') . '/'.  $this->input->post('sub_exam_id').'/' . $this->input->post('group_id')  , 'refresh');
	}
    ...
    function grade($param1 = '', $param2 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?superadmin/grade/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name'] = $this->input->post('name');
            $data['grade_point'] = $this->input->post('grade_point');
    ...
    function class_routine($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?superadmin/class_routine/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['class_id'] = $this->input->post('class_id');
            $data['subject_id'] = $this->input->post('subject_id');
    ...
    function invoice($param1 = '', $param2 = '', $param3 = '', $param4 = '') {
        ...
        if ($param1 == 'create') {
            ...
            if($num_rows > 0){
                ...
                redirect(base_url() . 'index.php?superadmin/invoice', 'refresh');
...
//            die;
            ...
            redirect(base_url() . 'index.php?superadmin/expense', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['expense_by'] = $this->input->post('expense_by');
            $data['expense_id'] = $this->input->post('expense_id');
...
//            die;
            ...
            redirect(base_url() . 'index.php?superadmin/income', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['income_by'] = $this->input->post('income_by');
            $data['income_id'] = $this->input->post('income_id');
    ...
    function monthlyReport($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'delete') {
            ...
            redirect(base_url() . 'index.php?superadmin/monthlyReport', 'refresh');
        }
    ...
    function fees_report($param1 = '', $param2 = '', $param3 = '') {
        if ($this->session->userdata('superadmin_login') != 1)
            redirect(base_url(), 'refresh');
        ...
        $page_data['page_title'] = translate('Fees Report');
        $this->load->view('index', $page_data);
    }
    function due_report() {
        if ($this->session->userdata('superadmin_login') != 1)
...
//                redirect(base_url() . 'index.php?superadmin/classWise/' . $page_data['class_id'], 'refresh');
//            } else {
//                $this->session->set_flashdata('class_report', 'Choose Class, to check Class Wise Report');
//                redirect(base_url() . 'index.php?superadmin/classWise/', 'refresh');
//            }
//        }
//        $page_data['class_id'] = $class_id;
...
//            print_r($page_data2); die;
          ...
          /*  $this->load->view('index', $page_data);
			return;
            */
            //redirect(base_url() . 'index.php?superadmin/income_report/'.$page_data['income_id'], 'refresh');
        }
	   	$this->db->order_by('income_id', 'asc');
        $page_data['incomes'] = $this->db->get('income')->result_array();
        $this->load->view('index', $page_data);
    ...
    function incomeReportByDate($start_date = '', $end_date = '') {
        ...
        if ($this->input->post('start_date') != '') {	
            ...
            if ($page_data['start_date'] != '' && $page_data['end_date'] != '') {
                redirect(base_url() . 'index.php?superadmin/incomeReportByDate/' . $page_data['start_date'], 'refresh');
            } else {
                $this->session->set_flashdata('class_report', 'Choose date to check date Wise Report');
                redirect(base_url() . 'index.php?superadmin/incomeReportByDate/', 'refresh');
            }
        }
...
//        $page_data['reports_by_date'] = $this->db->get_where('income',array('start_date <='=>$page_data['start_date'],'end_date >='=>$page_data['end_date']))->result_array();
    ...
    function salary_setup($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?superadmin/salary_setup/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['Basic'] = $this->input->post('Basic');
            $data['MedicalAllowance'] = $this->input->post('MedicalAllowance');
	...
	function salary_genarate($param1 = '', $param2 = '') {
		...
		if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?superadmin/salary_genarate/', 'refresh');
        }
	...
	function salary_status1111($param1 = '', $param2 = '') {
	   ...
	   function salary_status($param1 = '', $param2 = '') {
            ...
            redirect(base_url() . 'index.php?superadmin/salary_status/', 'refresh');
        }
       ...
       $page_data['page_name'] = 'salary_status';
		...
		//$this->load->view('index', $page_data);
            ...
            $this->load->view('superadmin/salary_status',$page_data);
       }
	...
	function salaryreport($param1 = '', $param2 = '') {
            ...
            $this->db->where('id', $param2);
            $this->db->delete('csalary');	
            redirect(base_url() . 'index.php?superadmin/salaryreport/', 'refresh');
        }
        ...
        $page_data['page_title'] = translate('Salary Report');
        $this->load->view('superadmin/salaryreport', $page_data);
    }
    ...
    function sectionWise($class_id = '') {
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['class_id'] > 0) {
                redirect(base_url() . 'index.php?superadmin/sectionWise/' . $page_data['class_id'], 'refresh');
            } else {
                $this->session->set_flashdata('class_report', 'Choose section, to check section Wise Report');
                redirect(base_url() . 'index.php?superadmin/sectionWise/', 'refresh');
            }
        }
        $page_data['class_id'] = $class_id;
    ...
    function dateWise($start_date = '', $end_date = '') {
        ...
        if ($this->input->post('start_date') != '') {
            ...
            if ($page_data['start_date'] != '' && $page_data['end_date'] != '') {
                ...
                redirect(base_url() . 'index.php?superadmin/dateWise/' . $page_data['start_date'] .'/'. $page_data['end_date'] , 'refresh');
            } else {
                $this->session->set_flashdata('class_report', 'Choose section, to check section Wise Report');
                redirect(base_url() . 'index.php?superadmin/dateWise/', 'refresh');
            }
        }
        //$page_data['class_id']   = $class_id;
    ...
    function statusWise($status = "") {
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['status']) {
                redirect(base_url() . 'index.php?superadmin/statusWise/' . $page_data['status'], 'refresh');
            } else {
                $this->session->set_flashdata('class_report', 'Choose Class, to check Class Wise Report');
                redirect(base_url() . 'index.php?superadmin/statusWise/', 'refresh');
            }
        }
    ...
    function book($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?superadmin/book', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name'] = $this->input->post('name');
            $data['description'] = $this->input->post('description');
    ...
    function transport($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?superadmin/transport', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['route_name'] = $this->input->post('route_name');
            $data['number_of_vehicle'] = $this->input->post('number_of_vehicle');
    ...
    function dormitory($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?superadmin/dormitory', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name'] = $this->input->post('name');
            $data['number_of_room'] = $this->input->post('number_of_room');
    ...
    function noticeboard($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?superadmin/noticeboard/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['notice_title'] = $this->input->post('notice_title');
            $data['notice'] = $this->input->post('notice');
    ...
    function fees_setup($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'create') 
		{
            ...
            redirect(base_url() . 'index.php?superadmin/fees_setup/', 'refresh');
        }
    ...
    function manage_profile($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'update_profile_info') {
            ...
            redirect(base_url() . 'index.php?superadmin/manage_profile/', 'refresh');
        }
         ...
         function student_info_sheet($param1='')
		 {
		 	if($param1=='upload_excel')
			{
			   ...
			   else
			   {
					...
					redirect('superadmin/student_info_sheet','refresh');
			   }
			}
		...
		function student_excel($class_id)
		{
			if($class_id)
				...
				$output=$this->gc->set_table('student')//->set_theme('flexigrid')
						...
						$this->load->view('superadmin/student_excel',$output);
				}
		}
...
$query = $this->db->get_where('student', array('student_id' => $student_id))->result_array();
    ...
    if($count==$arrayCount){
            ...
            function payslip($param='')
			{
						if($param=='all')
						{
							...
							$this->load->view('superadmin/payslip_all',$page_data);
						}
						else
						{
							$page_data['payslipid'] = $param;
							$this->load->view('superadmin/payslip',$page_data);
						}
		...
		function holiday($param1 = '', $param2 = '', $param3 = '') {
           ...
           redirect(base_url() . 'index.php?superadmin/holiday', 'refresh');
                                          } 
                 if ($param1 == 'do_update') {
           $data['holidayname'] = $this->input->post('holiday_name');
           $date_string= strtotime(str_replace('/', '-', $this->input->post('holiday_date')));
        ...
        function stattendancetype($param1 = '', $param2 = '', $param3 = '') {
           ...
           redirect(base_url() . 'index.php?superadmin/stattendancetype', 'refresh');
                                          } 
                 if ($param1 == 'do_update') {
         $data['attendance_type'] = $this->input->post('attendance_type');
           $data['short_form'] =$this->input->post('short_form');
      ...
      function student_attendance($month = '', $year = '', $class_id = '',$subject_id = '' , $group_name = '') {
	    ...
	    $page_data['year'] = $this->input->post('year');
            ...
            if ($page_data['month'] > 0 && $page_data['year'] > 0 && $page_data['class_id'] > 0 ) {
                redirect(base_url() . 'index.php?superadmin/student_attendance/' . $page_data['month'] . '/' . $page_data['year'] . '/' . $page_data['class_id'] . '/' . $page_data['subject_id'].'/' . $page_data['group_name'], 'refresh');
            }else {
                $this->session->set_flashdata('mark_message', 'Choose month,year and class');
                redirect(base_url() . 'index.php?superadmin/student_attendance/', 'refresh');
            }   
        }
	...
	function employee_attendance($month = '', $year = '') 
	{
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['month'] > 0 && $page_data['year'] > 0) {
                redirect(base_url() . 'index.php?superadmin/employee_attendance/' . $page_data['month'] . '/' . $page_data['year'], 'refresh');
            }else {
                $this->session->set_flashdata('mark_message', 'Choose month,year and class');
                redirect(base_url() . 'index.php?superadmin/employee_attendance/', 'refresh');
            }   
        }
      ...
      if ($this->input->post('operation') == 'update') {
		...
		$page_data['system_title'] = "Powered By Wemax Software Ltd.";
		$this->load->view('includes', $page_data);
        $this->load->view('superadmin/employee_attendance', $page_data);
    }
    ...
    function attendance_report($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            $page_data['start_month'] = $date_from_month;
			 ...
			 {
            		redirect(base_url() . 'index.php?superadmin/attendance_report/', 'refresh');          
             }
        ...
        if($student_class_id !=$page_data['class_id']){
              ...
              $this->load->view('includes', $page_data);
              $this->load->view('superadmin/attendance_report_details',$page_data);
    	...
    	function admit_card_print($param1 = '', $param2 = '', $param3 = '') 
	{
        ...
        $this->load->view('superadmin/admitcard_print', $page_data);
        }
        ...
        function view_admit_card($param1 = '') 
	{
        ...
        $data = $this->input->post('admitcard');
          ...
          $this->load->view('superadmin/view_admit_card', $page_data);
          //pdf crate
...
function testimonial(){
   ...
   function testimonial_print($param1 = '', $param2 = '', $param3 = '') 
        ...
        if ($this->session->userdata('superadmin_login') != 1)
         ...
         if ($param1 == 'do_update') {
           ...
           if ($param1 == 'delete') {
            ...
            $page_data['class_id'] =$param3;
           // redirect(base_url() . 'index.php?superadmin/testimonial_print', 'refresh');
        }
                if ($this->input->post('operation') == 'selection') 
		{
                        $page_data['class_id'] = $this->input->post('class_id');
        ...
        function view_testimonial($param1 = '') 
	{
		...
		$this->load->view('superadmin/view_testimonial', $page_data);
        }
    ...
    function transfar_certificate_print($param1 = '', $param2 = '', $param3 = '') 
	{
        ...
        $page_data['page_name'] = 'testimonial_print';
        $page_data['page_title'] = translate('testimonial Print');
        $this->load->view('superadmin/transfar_certificate_print', $page_data);
        }
        ...
        function view_transfar_certificate($param1 = '') 
	{
        ...
        $data = $this->input->post('TC');
          ...
          $this->load->view('superadmin/view_transfar_certificate', $page_data);
        }else{
           $page_data['print_all'] ="no";
           $page_data['admit_id'] =$param1; 
        ...
        $this->load->view('superadmin/teglist', $page_data);
        }
		function new_nav(){
         if ($this->session->userdata('superadmin_login') != 1)
            redirect(base_url(), 'refresh');    
        ...
        $this->load->view('superadmin/home', $page_data);
        }
		function update_setup() 
		{
			$this->config->set_item('global_xss_filtering',false);
			$this->config->set_item('grocery_crud_character_limiter',100);
        if ($this->session->userdata('superadmin_login') != 1)
            redirect(base_url(), 'refresh');
		$output=$this->gc
		->set_table('update')
		->set_theme('school')
		->set_subject(translate('update'))
		->unset_texteditor('code','full_text')
		->callback_column('code',function($value,$row)
		{
			return "<textarea rows=10 readonly style='width:400px;'>".($value)."</textarea>";
		})
		->unset_read()
		->render();
        $page_data['page_name'] = 'output';
        $page_data['page_title'] = translate('update_setup');
		$page_data['crud']=$output;
        $this->load->view('index', $page_data);
    }
	function check_update()
	{
		if ($this->session->userdata('superadmin_login') != 1)
            redirect(base_url(), 'refresh');    
        $page_data['page_info'] = translate('check_update');
        $page_data['page_title'] = translate('check_update');
		$page_data['page_name']='check_update';
		$page_data['module']='common';
        $this->load->view('index', $page_data);
	}
