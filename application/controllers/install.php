...
class Install extends CI_Controller {
	...
	function do_install()
	{
		...
		$purchase_verify		=	true;// $this->verify_purchase();
	...
	/*function verify_purchase()
	{
		...
		$curl 				=	curl_init('http://marketplace.envato.com/api/edge/isacfabian2/6837dijbodxe7ivte755c83p1zyf31om/verify-purchase:'.$purchase_code.'.xml');
