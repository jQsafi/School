        ...
        <?php if($this->session->userdata('user_role') != 'accountant'){ ?>
            <center>
                ...
                <span class="label label-blue hover-shadow"> 
                    <img src="template/images/icons/user.png" /> <span>Total Student Of School <?php echo $this->db->count_all_results('student'); ?> </span>
                </span>

                <span class="label label-blue hover-shadow">
                    <img src="template/images/icons/teacher.png" /><span>Total Teacher Of School <?php echo $this->db->count_all_results('teacher'); ?></span>
                </span>
            </center>
                ...
                <div class="row-fluid">
                    ...
                    <div class="span2 action-nav-button curl-top-left box-shadow-outset">
                        <a href="<?php echo base_url(); ?>index.php?admin/backup_restore">
                            ...
                            <span><?php echo translate('backup'); ?></span>
                        </a>
                    </div>
