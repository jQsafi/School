<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('admin/salary_setup/do_update/'.$row['id'] , array('class' => 'form-horizontal validatable','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                        <div class="padded">
                            ...
                            <div class="control-group">
                                <label class="control-label"><?php echo translate('Basic');?></label>
                                    <input type="text" name="Basic" value="<?php echo $row['Basic'];?>" />TK.
                            </div>
