                            ...
                            <div class="padded">  
                                ...
                                <div class="control-group custom-block">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="text" class="validate[required]" name="roll" placeholder="Enter roll no"/>&nbsp;<input type="text" class="validate[required] w150" name="academic_year" placeholder="Enter Academic Year "/>
                                    </div>
							<?php
