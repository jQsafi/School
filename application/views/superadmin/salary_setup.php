	...
	<div class="box-content padded">
		<div class="tab-content">
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open('admin/salary_setup/create' , array('class' => 'form-horizontal validatable','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                    <form method="post" action="<?php echo base_url();?>index.php?admin/salary_setup/create/" class="form-horizontal validatable" enctype="multipart/form-data">
                        <div class="padded">
							...
							<!--<div class="control-group">
                                <label class="control-label"><?php //echo get_phrase('Advance');?></label>
                                <div class="controls">
                                    <input type="text" onkeyup="changevalue6(this.value)"  placeholder="amount in %" />% &nbsp;&nbsp;&nbsp;
									<input type="text" name="Advance" id="Advance" placeholder="amount in Taka" />TK.
                                </div>
                            </div>
