...
<div class="box box-border">
	...
	<div class="box-content padded textarea-problem">
            ...
            <div class="tab-pane  <?php if(!isset($edit_data) && !isset($personal_profile) && !isset($academic_result) )echo 'active';?>" id="list">
				<center>
                <?php echo form_open('admin/progress_card');?>
					...
					<tbody>
						...
						<?php
							...
							if($exam)
							{
								...
								$link=site_url('admin/progress_card_details/'.$student_id.'/'.$exam.'/'.$class_id);
							}
							if(!$exam)
							{
								$exam_name='All Exam';
								...
								$link=site_url('admin/progress_card_details/'.$student_id.'/all/'.$class_id);
