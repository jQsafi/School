...
<?php endforeach; ?>
            		...
            		<center><div class="action-nav-normal">
                        <div class="action-nav-button" style="width:300px;">
                                    <a href="<?=site_url('superadmin/teacher')?>" title="Teachers">
								...
								<div class=" action-nav-button" style="width:300px;">
                                    <a href="<?=site_url('superadmin/teacher/1')?>" title="Teacher">
                                        <img src="<?php echo base_url(); ?>template/images/icons/user.png" />
                                        <span><?php 
										$condition['status']=1;
								...
								<div class=" action-nav-button" style="width:300px;">
                                    <a href="<?=site_url('superadmin/teacher/0')?>" title="Users">
                                        <img src="<?php echo base_url(); ?>template/images/icons/user.png" />
                                        <span><?php
										$condition['status']=0;
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                         ...
                                         <div class="btn-group action-dropdown">
                                            ...
                                            <li>
                                            <a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?superadmin/teacher/delete/<?php echo $row['teacher_id'];?>')" target="_blank">
			...
			<!--<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open('superadmin/teacher/create' , array('class' => 'form-horizontal validatable','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                    <form method="post" action="<?php echo base_url();?>index.php?superadmin/teacher/create/" class="form-horizontal validatable" enctype="multipart/form-data">
                        <div class="padded">
