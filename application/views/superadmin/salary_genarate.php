        ...
        <div class="box-content padded">
            <div class="tab-content">
                ...
                <div class="tab-pane  active" id="list">
                    <center>
                        <br />
                        <select name="teacher_id" onchange="window.location='<?php echo base_url(); ?>index.php?admin/salary_genarate/'+this.value">
                        ...
                        <div class="box">
                            <div class="box-content">
                                <div class="box-content">
                	<?php echo form_open('admin/salary_genarate/create' , array('class' => 'form-horizontal validatable','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
						...
						<div class="control-group">
						  ...
						  <div class="control-group">
                                <label class="control-label"><?php echo translate('Basic');?></label>
                                    <input type="text" name="Basic" value="<?php echo $row['Basic'];?>" DISABLED />TK.
                            </div>
                            ...
                            <div class="control-group">
                                <label class="control-label"><?php echo translate('Medical_Allowance');?></label>
									<input type="text" name="MedicalAllowance" DISABLED placeholder="amount in Taka" value="<?php echo $row['MedicalAllowance'];?>" />TK.
                            </div>
                            
                            
                             <div class="control-group">
                                <label class="control-label"><?php echo translate('House_Rent');?></label>
									<input type="text" name="HouseRent" DISABLED placeholder="amount in Taka" value="<?php echo $row['HouseRent'];?>" />TK.
                                </div>
                             ...
                             <div class="control-group">
                                <label class="control-label"><?php echo translate('Convince');?></label>
									<input type="text" name="Convince" DISABLED placeholder="amount in Taka" value="<?php echo $row['Convince'];?>" />TK.
                            </div>
