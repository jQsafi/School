<div class="tab-pane box active edit-student-container" id="edit" style="padding: 5px">
    <div class="box-content">
        <?php foreach ($edit_data as $row): ?>
            <?php echo form_open('admin/income/do_update/' . $row['inc_id'], array('class' => 'form-horizontal validatable', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
            ...
            <div class="padded">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" class="datepicker fill-up" name="income_date" value="<?php echo date('m/d/Y',$row['income_timestamp']); ?>" required=""/>
                    </div>
                </div>
                <div class="control-group">
