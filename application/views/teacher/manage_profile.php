                    ...
                    foreach($edit_data as $row):
                        ...
                        <?php echo form_open('teacher/manage_profile/update_profile_info' , array('class' => 'form-horizontal validatable'));?>
                                ...
                                <div class="form-actions">
                            		<button type="submit" class="btn btn-blue"><?php echo translate('update_profile');?></button>
                        		</div>
                        </form>
						<?php
                    endforeach;
                ...
                <div class="box-content padded">
                    ...
                    foreach($edit_data as $row):
                        ...
                        <?php echo form_open('teacher/manage_profile/change_password' , array('class' => 'form-horizontal validatable'));?>
                                ...
                                <div class="form-actions">
                            		<button type="submit" class="btn btn-blue"><?php echo translate('update_password');?></button>
                        		</div>
                        </form>
						<?php
                    endforeach;
