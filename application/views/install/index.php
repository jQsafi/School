...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="content">
                ...
                <div id="steps">
                    <?php echo form_open('install/do_install' , array('id' => 'formElem' , 'name' => 'formElem'));?>
                        ...
                        <fieldset class="step">
                            ...
                            <p>
                                <label for="name" style="width:156px !important;">User</label>
                                <input id="codecanyon_username" name="buyer" type="text" AUTOCOMPLETE=OFF />
                            </p>
                            <p>
                                <label for="phone" style="width:156px !important;">School Code</label>
            ...
            <!---------facebook like page---------->
            <br>
            <iframe src="//www.facebook.com/plugins/likebox.php?href=https://www.facebook.com/Ekattor.School.College.Management.System&amp;width=380&amp;height=62&amp;show_faces=false&amp;colorscheme=light&amp;stream=false&amp;border_color&amp;header=false" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:380px; height:62px;" allowTransparency="true"></iframe>
			<!---------facebook like page--------->
