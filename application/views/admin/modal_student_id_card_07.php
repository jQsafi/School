...
foreach ($student_info as $row):
    ...
    <style>
        ...
        .id-body {
			...
			background: url(template/images/id_card/card_design7/design7-bg.svg) no-repeat;
        }
        .id-wrap {
            padding: 20px;
        }
        .id-card-photo {
            border: 3px solid #214181;
			width: 141px;
			height: 177px;
    ...
    <div class="id-body">
        <div class="id-wrap">
            <!--ID Card Logo-->
            <div>
                <img src="<?php echo base_url(); ?>template/images/id_card/card_design7/school-logo.png" width="269" height="63">
            </div>
            <!--ID Card Logo-->
