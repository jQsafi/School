                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive" id="xsaralyreport" style="overflow-x: auto;">
                    ...
                    <?php 
                        ...
                        foreach ($salaryreport as $row): ?>
							...
							<!--	<td><a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?admin/salary_status/delete/<?php echo $row['id'];?>')" class="btn btn-red btn-small">
                                                    ...
                                                    <i class="icon-trash"></i> <?php echo translate('delete');?>
                                                                ...
                                                                <td><a href="<?php echo base_url();?>index.php?admin/payslip/<?php echo $row['id'];?>" window="new" win_height="816px" win_width="1200px" class="btn btn-red btn-small">
