<div class="text-hd cool" style="margin:0 auto;text-align: center;background-color:rgba(64, 180, 64, 0.71);padding:10px;border: soild;">
		<?=get_single_value('system_name','settings')?>
</div>
...
<script>
    $(document).ready(function() {
        ...
        $("#calendar2").fullCalendar({
            ...
            drop: function (e, t) {
              var n, r;
              r = $(this).data("eventObject"), n = $.extend({}, r), n.start = e, n.allDay = t, 
