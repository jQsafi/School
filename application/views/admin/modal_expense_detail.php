...
$expense_info = $this->crud_model->get_expense_info($current_expense_id);
...
<div class="invoice-container">
    <div class="wraper clearfix">        
        ...
        <div class="invoice-description">
            <table width="100%">
                <tr>
                    <td style="text-align: left;"><strong><?php echo translate('Expense ID'); ?>: </strong><?php echo $row['expense_id']; ?></td>
                    <td style="text-align: center;"></td>
                    <td style="text-align: right;"><strong><?php echo translate('Issue Date'); ?>: </strong><?php echo date('j F, Y', $row['expense_timestamp']); ?></td>
                </tr>
                <tr>
                    <td colspan="3"><p><strong><?php echo translate('Payment to'); ?>: </strong><?php echo $row['payment_to']; ?></p></td>
                </tr>
            </table>
        </div>
        ...
        <div class="fees-details">
            <table width="100%">
                ...
                <tr>
                    <td><?php echo translate('expense_id'); ?></td>
                    <td><?php echo $row['expense_id']; ?></td>
                </tr>
                <?php } ?>
                <?php if($row['expense_by'] != '') { ?>
                <tr>
                    <td><?php echo translate('Expense by'); ?></td>
                ...
                <?php } ?>
                <?php if($row['expense_name'] != '') { ?>
                <tr>
                    <td><?php echo translate('expense_name'); ?></td>
                ...
                <?php } ?>
                <?php if($row['expense_date'] != '') { ?>
                <tr>
                    <td><?php echo translate('expense_date'); ?></td>
                    <td><?php echo date('j F, Y', $row['expense_timestamp']); ?></td>
                </tr>
                <?php } ?>
                <?php if($row['amount'] != '') { ?>
                <tr>
