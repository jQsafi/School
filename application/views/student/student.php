		...
		<ul class="nav nav-tabs nav-tabs-left">
			...
			<li class="active">
            	<a href="#edit" data-toggle="tab"><i class="icon-wrench"></i> 
					<?php echo translate('personal_profile');?>
                    	</a></li>
            <?php endif;?>
        	<?php if(isset($academic_result)):?>
			<li class="active">
            	<a href="#edit" data-toggle="tab"><i class="icon-wrench"></i> 
					<?php echo translate('academic_result');?>
                    	</a></li>
            <?php endif;?>
        	<?php if(isset($edit_data)):?>
			<li class="active">
            	<a href="#edit" data-toggle="tab"><i class="icon-wrench"></i> 
					<?php echo translate('edit_student');?>
                    	</a></li>
            <?php endif;?>
                    ...
                    <form method="post" action="<?php echo base_url();?>index.php?student/student/create/" class="form-horizontal validatable" enctype="multipart/form-data">
                        <div class="padded">
                            ...
                            <div class="control-group">
                                <label class="control-label"></label>
                                <div class="controls" style="width:210px;">
                                    <a href="<?php echo base_url();?>/photo/" target="_blank"><img id="blah" src="<?php echo base_url();?>uploads/user.jpg" alt="your image" height="100" /></a>
                                </div>
                            </div>
                        </div>
                        <div class="form-actions">
                            <button type="submit" class="btn btn-blue"><?php echo translate('add_student');?></button>
                        </div>
                    </form>                
                </div>                
			</div>
