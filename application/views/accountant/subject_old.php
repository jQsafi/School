		...
		<div class="tab-content">            
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?accountant/subject/delete/<?php echo $row['subject_id'];?>')" class="btn btn-red btn-small">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?accountant/college/delete/<?php echo $row['subject_id'];?>')" class="btn btn-red btn-small">
                                		<i class="icon-trash"></i> <?php echo translate('delete');?>
                                </a>
        					</td>
                        </tr>
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open('accountant/subject/create' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                        <div class="padded">
			...
			<div class="tab-pane box" id="addcollege" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open('accountant/college/create' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                        <div class="padded">
                            <div class="control-group">
                                <label class="control-label"><?php echo translate('name');?></label>
                                <div class="controls">
