...
<script>
	function select_student()
	{
		...
		$.ajax({
		  url: "<?php echo site_url('accountant/studentlist/'); ?>/"+class_id,
...
<div class="box box-border">
	...
	<div class="box-content padded textarea-problem">
            ...
            <div class="tab-pane  <?php if(!isset($edit_data) && !isset($personal_profile) && !isset($academic_result) )echo 'active';?>" id="list">
				<center>
                <?php echo form_open('accountant/bill_collection/create');?>
                <table border="0" cellspacing="0" cellpadding="0" class="table table-normal box">
                	<tr>
                        ...
                        <td>
                        	<select name="student_id"  class="select chzn-select" id="students"><!--chzn-select-->
                ...
                <?php 
					...
					echo form_open('accountant/bill_collection/collect');
 ...
 <script>
	...
	$(function()
	{
	 	...
	 	$(".collection").keyup(function()
		{
			...
			$("#total_collection").val(total_fine+total_collection);
			$("#pay_fine").html(total_fine+total_collection);
			$("#total_fine").val(total_fine);
		});
