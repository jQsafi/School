<div class="tab-pane box active edit-student-container" id="edit" style="padding: 5px">
    <div class="box-content">
        <?php foreach ($edit_data as $row): ?>
            <?php echo form_open('accountant/income/do_update/' . $row['inc_id'], array('class' => 'form-horizontal validatable', 'target' => '_parent', 'enctype' => 'multipart/form-data')); ?>

            <div class="padded">
                <div class="control-group">
                    <div class="avatar">
                        <img style="max-height: 150px;" id="blah" class="avatar-large" src="<?php echo $this->crud_model->get_image_url('income', $row['inc_id']); ?>" height="100"  />
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" class="datepicker fill-up" name="income_date" value="<?php echo date('d-m-Y',$row['income_timestamp']); ?>" required=""/>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label"><?php echo translate('income By'); ?></label>
                    <div class="controls">
                        <input type="text" class="" name="income_by" value="<?php echo $row['income_by']; ?>" required=""/>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label"><?php echo translate('Income ID'); ?></label>
                    <div class="controls">
                        <input type="text" class="" name="income_id" value="<?php echo $row['income_id']; ?>"/>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" class="" name="income_name" value="<?php echo $row['income_name']; ?>"/>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="form-actions">
                    <button type="submit" class="btn btn-gray"><?php echo translate('edit_income'); ?></button>
                </div>
            <?php endforeach; ?>
        </div>
    </div>
