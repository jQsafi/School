    ...
    <div class="box box-border">
        ...
        <div class="box-content padded">
            <div class="tab-content">
				...
				<div class="pull-left student-info-upload">
					<center>
					<?php echo form_open('accountant/student_info_sheet/upload_excel', array('class' => 'form-horizontal validatable', 'enctype' => 'multipart/form-data')); ?>
    ...
    function setclassvalue()
	{
	   ...
	   if(!class_id)
	   return false;
	   var open_url="<?=site_url('accountant/student_excel')?>/"+class_id;
