            ...
            <div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content padded">
                    ...
                    foreach ($settings as $row):
                        ?>
                        <?php echo form_open('accountant/system_settings/' . $row['type'] . '/do_update/', array('class' => 'form-horizontal validatable', 'target' => '_top')); ?>
                        <form method="post" action="<?php echo base_url(); ?>index.php?accountant/system_settings/<?php echo $row['type']; ?>/do_update/" class="form-horizontal validatable">
