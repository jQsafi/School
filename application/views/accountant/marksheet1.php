...
<!--                        <td><?php echo translate('select_class');?></td>
		...
		?>
                ...
                <table class="table table-normal box" >
                    ...
                    <tbody>
                        <tr>
                            <td><a href="<?php echo base_url();?>index.php?/accountant/marksheet_single/<?php echo isset($item->class_id) ? $item->class_id : '';  echo isset($item->student_id) ? '/'.$item->student_id : '';?>"><?php echo $item->student_unique_ID;?></a></td>
