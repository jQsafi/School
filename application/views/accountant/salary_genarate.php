        ...
        <div class="box-content padded">
            <div class="tab-content">
                ...
                <div class="tab-pane  active" id="list">
                    <center>
                        <br />
                        <select name="teacher_id" onchange="window.location='<?php echo base_url(); ?>index.php?accountant/salary_genarate/salary_info/'+this.value">
                        ...
                        <div class="box">
                            <div class="box-content">
                                <div class="box-content">
                	<?php echo form_open('accountant/salary_genarate/create' , array('class' => 'form-horizontal validatable','target'=>'_self', 'enctype' => 'multipart/form-data'));?>
                    <form method="post" action="<?php echo base_url();?>index.php?accountant/salary_genarate/create/" class="form-horizontal validatable" enctype="multipart/form-data">
                        <div class="padded">
...
({
type: "POST",
url: baseurl+"index.php?accountant/teacherid/"+teacherid,
