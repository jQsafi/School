...
<div class="box box-border">
    ...
    <div class="box-content padded textarea-problem clearfix">
        ...
        <div class="tab-pane  active" id="list">
            <center>
                <?php echo form_open('accountant/salaryreport'); ?>
                    ...
                    <?php 
                        ...
                        foreach ($salaryreport as $row): ?>
                            <tr>
								...
								<!--<td><a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?accountant/salaryreport/delete/<?php echo $row['id'];?>')" class="btn btn-red btn-small">
