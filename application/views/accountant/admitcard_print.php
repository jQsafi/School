...
<div class="box box-border"  id="main_body">
	...
	<div class="box-content padded textarea-problem">
            ...
            <div class="tab-pane  <?php if(!isset($edit_data) && !isset($personal_profile) && !isset($academic_result) )echo 'active';?>" id="list">
				<center>
                <?php echo form_open('accountant/admit_card_print');?>
                ...
                <?php 
							...
							echo form_open('accountant/view_admit_card',array('target'=>'_blank')); 
				   ...
				   <input type="hidden" id="totalexam" value="<?php echo $tot_exams; ?>" > 			
					...
					<tbody>
						...
						<input type="hidden"  value="<?php echo $exam_id;?>" name="exam_id">
							...
							if($group_id)
								$students = $this->db->get_where('student', array('class_id' => $class_id,'group' => $group_id,'status'=>1))->result_array();
								else
								$students = $this->db->where(array('class_id' => $class_id,'status'=>1))->order_by('roll')->get('student')->result_array();
										...
										<td>
                                                 ...
                                                 <input type="checkbox" class="admitcard<?php echo $countype; ?>" name="admitcard[]" value="<?php echo $admitdetail['admit_id'];?>"/> 
                                                       ...
                                                       Action
                                                        ...
                                                        <li> 
                                                            <a href="<?php echo base_url();?>index.php?accountant/view_admit_card/<?php echo $admitdetail['admit_id'];?>" window="new" win_height="816px" win_width="1200px" >
														...
														if ($this->session->userdata('user_role') != 'accountant/') { ?>
                                                          ...
                                                          <a href="<?php echo site_url('modal/popup/edit_admitcard/'.$admitdetail['admit_id']);?>" window="new" win_height="800px" win_width="1000px"><i class="icon-wrench"></i> <?php echo translate('edit'); ?></a>    
                                                            ...
                                                            <li> 
																...
																onclick="modal_delete('<?=site_url('accountant/admit_card_print/delete/'.$admitdetail['admit_id'].'/'.$class_id)?>')">
