...
<div class="box box-border">
	...
	<div class="box-content padded textarea-problem">
            ...
            <div class="tab-pane  <?php if(!isset($edit_data) && !isset($personal_profile) && !isset($academic_result) )echo 'active';?>" id="list">
				<center>
                <?php echo form_open('accountant/marksheet');?>
					...
					<tbody>
						...
						<?php
							...
							if($exam)
							{
								...
								$link=site_url('progress_card/progress_card_details_3/'.$student_id.'/'.$exam.'/'.$class_id);
							}
							if(!$exam)
							{
								$exam_name='All Exam';
								...
								$link=site_url('progress_card/progress_card_details_3/'.$student_id.'/all/'.$class_id);
								$lg=get_letter_grade($gpa);
							}
							if($lg=='F')
							{
                        ...
                        <tr href="<?php echo $link;?>"  window="new" win_height="816px" win_width="1200px">
							<td>
								<?=$sl?>
							</td>
                            <td>
