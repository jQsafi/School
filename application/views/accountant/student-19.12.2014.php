        ...
        <div class="box-content padded">
            <div class="tab-content">
                ...
                <div class="tab-pane  active" id="list">
                    <center>
                        <br />
                        <select name="class_id" onchange="window.location='<?php echo base_url(); ?>index.php?accountant/student/'+this.value">
                ...
                <div class="tab-pane box" id="add" style="padding: 5px">
                    <?php if (count($students) <= 500) { ?>
                        <div class="box-content">
                            <?php echo form_open('accountant/student/create/', array('class' => 'form-horizontal validatable', 'enctype' => 'multipart/form-data')); ?>
                            <div class="padded">
