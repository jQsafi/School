	...
	<div class="box-content padded textarea-problem">
            ...
            <div class="tab-pane  <?php if(!isset($edit_data) && !isset($personal_profile) && !isset($academic_result) )echo 'active';?>" id="list">
				<center>
                <?php echo form_open('accountant/testimonial_print');?>
                ...
                <?php 
							...
							echo form_open('accountant/view_testimonial'); 
				   ...
				   <input type="hidden" id="totalexam" value="<?php echo $tot_exams; ?>" > 			
					...
					<tbody>
						...
						<input type="hidden"  value="<?php echo $exam_id;?>" name="exam_id">
                            ...
                            $testimonials = $this->db->get_where('testimonial', array('class_id' => $class_id,'student_id' => $student_id))->result_array(); 
                                             ?>
										...
										<td>
                                                 ...
                                                 <input type="checkbox" class="testimonial" name="testimonial[]" value="<?php echo $testimonial['testimonial_id'];?>"/> 
											
                                                                                                                          <div class="btn-group action-dropdown">
                                                       <button class="btn btn-gray btn-normal dropdown-toggle" data-toggle="dropdown">
                                                      
                                                           TS DATE:<?php echo $testimonial['Date']; ?>
                                                        </button>
                                                        
                                                        <ul class="dropdown-menu">
                                                        
                                                        <li> 
                                                            <a href="<?php echo base_url();?>index.php?accountant/view_testimonial/<?php echo $testimonial['testimonial_id'];?>" window="new" win_height="842px" win_width="1000px" >
                                                      <i class="icon-file-alt"></i><?php echo translate('view');?>
														...
														if ($this->session->userdata('user_role') != 'accountant/') { ?>
                                                          ...
                                                          <a href="<?php echo site_url('modal/popup/edit_testimonial/'.$testimonial['testimonial_id']);?>" window="new" win_height="800px" win_width="1000px"><i class="icon-wrench"></i> <?php echo translate('edit'); ?></a>    
                                                            ...
                                                            <li> 
                                                                ...
                                                                <a  href="<?php echo base_url(); ?>index.php?accountant/testimonial_print/delete/<?php echo $testimonial['testimonial_id']; ?>/<?php echo $class_id; ?>" class="">
