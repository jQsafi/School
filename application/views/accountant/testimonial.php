...
<div class="box box-border">
	...
	<div class="box-content padded textarea-problem">
            ...
            <div class="tab-pane  <?php if(!isset($edit_data) && !isset($personal_profile) && !isset($academic_result) )echo 'active';?>" id="list">
				<center>
                <?php echo form_open('accountant/testimonial');?>
                ...
                <?php 
							...
							echo form_open('accountant/testimonial'); 
							
							?>
                   <a class="btn btn-gray btn-normal dropdown-toggle" href="<?php echo base_url(); ?>index.php?accountant/teglist" rel="tooltip" data-placement="right" 
