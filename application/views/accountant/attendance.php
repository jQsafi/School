		...
		<div class="tab-content">            
			...
			<div class="tab-pane box active" id="attendance1" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open('accountant/attendance/attendancebox' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                        <div class="padded">
                            <div class="control-group custom-block">                                    
                                    <label class="control-label"><?php echo translate('student_Attendance'); ?></label>
                                    <div class="controls">
									
					 <a class="btn btn-blue" href="<?php echo base_url(); ?>index.php?accountant/student_attendance" rel="tooltip" data-placement="right" 
                ...
                <span><?php echo translate('manage_student_Attendance'); ?></span>
                             ...
                             <div class="control-group custom-block">                                    
                                    ...
                                    <div class="controls">
                         				 ...
                         				 <a class="btn btn-blue" href="<?php echo base_url(); ?>index.php?accountant/employee_attendance" rel="tooltip" data-placement="right" 
               data-original-title="" window="new" win_height="816px" win_width="1200px">
