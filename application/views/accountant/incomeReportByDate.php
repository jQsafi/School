<div class="box box-border">#################
        ...
        <ul class="nav nav-tabs nav-tabs-left">
            <li class="active">
                <a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> 
                    <?php echo translate('income Report By Date'); ?>
                </a></li>
        </ul>
        <!------CONTROL TABS END------->
    ...
    <div class="box-content padded textarea-problem">
        ...
        <div class="tab-pane active" id="list">
            <center>
                <?php echo form_open('accountant/incomeReportByDate'); ?>
                    ...
                    <tr>
                        <td>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input style="width: 150px;" type="text" class="datepicker fill-up" name="start_date" required=""/>
                                </div>
                            </div>
                        </td>
                        ...
                        <td>    
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input style="width: 150px;" type="text" class="datepicker fill-up" name="end_date" required=""/>
                                </div>
                            </div>
            ...
            <?php if($start_date != ""): ?>
                ...
                //$invoices = $this->crud_model->get_all_student_invoice_by_date();
...
<!--                            <th><div><?php echo translate('amount'); ?></div></th>
                    ...
                    <tbody>
                        <?php foreach ($reports_by_date as $row): ?>
                            <tr>
