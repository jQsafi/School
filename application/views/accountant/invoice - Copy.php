    ...
    <div class="box-content padded">
        <div class="tab-content">
                        ...
                        foreach ($invoices as $row): //echo '<pre>'; print_r($row);
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url(); ?>index.php?accountant/invoice/delete/<?php echo $row['invoice_id']; ?>')" class="btn btn-red btn-small">
            ...
            <div class="tab-pane box" id="classwise">
                <center>
                    <br />
                    <select name="class_id" onchange="window.location='<?php echo base_url(); ?>index.php?accountant/invoice/'+this.value">
                                        ...
                                        foreach ($students as $row):
                                            ...
                                            <tr>
                                                ...
                                                <td align="center" class="span5">
                                                    ...
                                                    <a  data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url(); ?>index.php?accountant/student/<?php echo $class_id; ?>/delete/<?php echo $row['student_id']; ?>')" class="btn btn-red btn-small">
                                                        <i class="icon-trash"></i> <?php echo translate('delete'); ?>
                                                    </a>

                                                                            <!--<a href="<?php echo base_url(); ?>index.php?accountant/student/<?php echo $class_id; ?>/personal_profile/<?php echo $row['student_id']; ?>"
                                                                                class="btn btn-gray">
                                                                                    <i class="icon-wrench"></i> <?php echo translate('personal_profile'); ?>
                                                                            </a>
                                                                            <a href="<?php echo base_url(); ?>index.php?accountant/student/<?php echo $class_id; ?>/academic_result/<?php echo $row['student_id']; ?>"
                                                                                class="btn btn-gray">
                                                                                    <i class="icon-wrench"></i> <?php echo translate('academic_result'); ?>
                                                                            </a>
                                                                            <a href="<?php echo base_url(); ?>index.php?accountant/student/<?php echo $class_id; ?>/edit/<?php echo $row['student_id']; ?>"
                                                                                class="btn btn-gray">
                                                                                    <i class="icon-wrench"></i> <?php echo translate('edit'); ?>
                                                                            </a>
                                                                            <a href="<?php echo base_url(); ?>index.php?accountant/student/<?php echo $class_id; ?>/delete/<?php echo $row['student_id']; ?>" onclick="return confirm('delete?')"
                                                                                class="btn btn-red">
                                                                                    <i class="icon-trash"></i> <?php echo translate('delete'); ?>
                                                                            </a>-->
...
//                        foreach($fees_all as $row_fee):
                    ?>
                    <?php echo form_open('accountant/invoice/create', array('class' => 'form-horizontal validatable', 'target' => '_top')); ?>
                    <div class="padded">
                        <?php /* if ($class_id == ''): ?>
                            <div id="ask_class" class="  alert alert-info  " style="width:300px;">
...
<!--                                     onchange="window.location='<?php echo base_url(); ?>index.php?accountant/invoice/loadfee_by_class/'+this.value"-->
                        ...
                        <?php /*
                          ...
                          ?>
                          <?php //echo form_open('accountant/fees_setup/' . $row['fees_name'] . '/do_update/', array('class' => 'form-horizontal validatable', 'target' => '_top')); ?>
                          <!--                        <form method="post" action="<?php echo base_url(); ?>index.php?accountant/fees_setup/<?php echo $row['fees_name']; ?>/do_update/" class="form-horizontal validatable">-->
...
<script type="text/javascript">
    ...
    $("select.classId").on("change", function(event) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url(); ?>/index.php?accountant/invoice/loadfee_by_class/"+class_id,
            dataType: "html",                
