<div class="tab-pane box active" id="edit" style="padding: 5px">
    <div class="box-content">
        ...
        <?php echo form_open('accountant/parent/do_update/'.$row['parent_id'].'/'.$class_id , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
            <div class="padded">
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-gray"><?php echo translate('edit_parent');?></button>
            </div>
        </form>
        <?php endforeach;?>
    </div>
