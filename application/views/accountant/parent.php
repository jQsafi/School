		...
		<ul class="nav nav-tabs nav-tabs-left">
			<li class="active">
            	<a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> 
					<?php echo translate('parent_list');?>
                    	</a></li>
		</ul>
    	<!------CONTROL TABS END------->
	...
	<div class="box-content">
		<div class="tab-content">
            ...
            <div class="tab-pane  active" id="list">
				<center>
                	<br />
                	<select name="class_id" onchange="window.location='<?php echo base_url();?>index.php?accountant/parent/'+this.value">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive ">
                            <thead>
                                <tr>
                                    ...
                                    <th><div><?php echo translate('parent_name');?></div></th>
                                    <th><div><?php echo translate('relation_with_student');?></div></th>
                                    <th><div><?php echo translate('parent_email');?></div></th>
                                    <th><div><?php echo translate('parent_phone');?></div></th>
                                    <th><div><?php echo translate('parrent_address');?></div></th>
                                    <th><div><?php echo translate('parrent_occupation');?></div></th>
                                    <th style="width:140px;"><div><?php echo translate('options');?></div></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php 
                                    ...
                                    <td align="center" class="span5">
                                        ...
                                        <a  data-toggle="modal" href="#modal-form" onclick="modal('add_parent',<?php echo $row['student_id'];?>,<?php echo $class_id;?>)" 
                                        	class="btn btn-default btn-small">
                                            	<i class="icon-plus"></i> <?php echo translate('add');?>
                                        </a>
                                        <?php
											else:
										?>
                                        ...
                                        <a  data-toggle="modal" href="#modal-delete" 
                                        	onclick="modal_delete('<?php echo base_url();?>index.php?accountant/parent/delete/<?php echo $parent_info->parent_id;?>/<?php echo $class_id;?>')" 
		...
		<div class="box-content padded">
            ...
            <script>
                $(document).ready(function() {
                    function ask()
                    {
                        Growl.info({title:"Select a class to manage Guardian",text:" "});
                    }
                    setTimeout(ask, 500);
                });
            </script>
