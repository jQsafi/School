...
<script>
	...
	{
		$.ajax({
		  url: "<?php echo site_url('accountant/studentlist/'); ?>/"+student_class,
...
<div class="box box-border">
    ...
    <div class="box-content padded textarea-problem">
        ...
        <div class="tab-pane" id="list">
                <?php echo form_open(site_url('accountant/fees_report/show_report'),array('class'=>'form-control'),array('posted'=>TRUE)); ?>
