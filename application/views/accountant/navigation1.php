...
<div class="primary-sidebar">
    ...
    <ul class="nav nav-collapse collapse nav-collapse-primary">
        ...
        <li class="<?php if ($page_name == 'dashboard') echo 'dark-nav active'; ?>">
            ...
            <a href="<?php echo base_url(); ?>index.php?accountant/dashboard" rel="tooltip" data-placement="right" 
        ...
        <li class="<?php if ($page_name == 'student') echo 'dark-nav active'; ?>">
                <!--<span class="glow"></span>-->
            <a href="<?php echo base_url(); ?>index.php?accountant/student" rel="tooltip" data-placement="right" 
        ...
        <li class="<?php if ($page_name == 'student_add') echo 'dark-nav active'; ?>">
                <!--<span class="glow"></span>-->
            <a href="<?php echo base_url(); ?>index.php?accountant/student_add" rel="tooltip" data-placement="right" 
               data-original-title="<?php /* ?><?php echo translate('student_help');?><?php */ ?>">
                               <!--<i class="icon-user icon-1x"></i>-->
                <img src="<?php echo base_url(); ?>template/images/icons/user.png" />
        ...
        <li class="<?php if ($page_name == 'teacher') echo 'dark-nav active'; ?>">
                <!--<span class="glow"></span>-->
            <a href="<?php echo base_url(); ?>index.php?accountant/teacher" rel="tooltip" data-placement="right" 
        ...
        <li class="<?php if ($page_name == 'parent') echo 'dark-nav active'; ?>">
                <!--<span class="glow"></span>-->
            <a href="<?php echo base_url(); ?>index.php?accountant/parent" rel="tooltip" data-placement="right" 
               data-original-title="<?php /* ?><?php echo translate('teacher_help');?><?php */ ?>">
                               <!--<i class="icon-user icon-1x"></i>-->
        ...
        <li class="<?php if ($page_name == 'subject') echo 'dark-nav active'; ?>">
                <!--<span class="glow"></span>-->
            <a href="<?php echo base_url(); ?>index.php?accountant/subject" rel="tooltip" data-placement="right" 
        ...
        <li class="<?php if ($page_name == 'class') echo 'dark-nav active'; ?>">
                <!--<span class="glow"></span>-->
            <a href="<?php echo base_url(); ?>index.php?accountant/classes" rel="tooltip" data-placement="right" 
        ...
        <li class="<?php if ($page_name == 'exam') echo 'dark-nav active'; ?>">
                <!--<span class="glow"></span>-->
            <a href="<?php echo base_url(); ?>index.php?accountant/exam" rel="tooltip" data-placement="right" 
        ...
        <li class="<?php if ($page_name == 'marks') echo 'dark-nav active'; ?>">
                <!--<span class="glow"></span>-->
            <a href="<?php echo base_url(); ?>index.php?accountant/marks" rel="tooltip" data-placement="right" 
        ...
        <li class="<?php if ($page_name == 'marksheet') echo 'dark-nav active'; ?>">
                <!--<span class="glow"></span>-->
            <a href="<?php echo base_url(); ?>index.php?accountant/marksheet" rel="tooltip" data-placement="right" 
               data-original-title="<?php /* ?><?php echo translate('marks_help');?><?php */ ?>">
                               <!--<i class="icon-pencil icon-1x"></i>-->
                <img src="<?php echo base_url(); ?>template/images/icons/marks.png" />
        ...
        <li class="<?php if ($page_name == 'grade') echo 'dark-nav active'; ?>">
                <!--<span class="glow"></span>-->
            <a href="<?php echo base_url(); ?>index.php?accountant/grade" rel="tooltip" data-placement="right" 
        ...
        <li class="<?php if ($page_name == 'class_routine') echo 'dark-nav active'; ?>">
                <!--<span class="glow"></span>-->
            <a href="<?php echo base_url(); ?>index.php?accountant/class_routine" rel="tooltip" data-placement="right" 
        ...
        <li class="<?php if ($page_name == 'attendance') echo 'dark-nav'; ?>">
                <!--<span class="glow"></span>-->
            <a href="<?php echo base_url(); ?>index.php?accountant/attendance" rel="tooltip" data-placement="right" 
               data-original-title="<?php /* ?><?php echo translate('dashboard_help');?><?php */ ?>">
                <!--<i class="icon-desktop icon-1x"></i>-->
                <img src="<?php echo base_url(); ?>template/images/icons/home.png" />
        ...
        <li class="<?php if ($page_name == 'invoice') echo 'dark-nav active'; ?>">
                <!--<span class="glow"></span>-->
            <a href="<?php echo base_url(); ?>index.php?accountant/invoice" rel="tooltip" data-placement="right" 
        ...
        <li class="<?php if ($page_name == 'report') echo 'dark-nav active'; ?>">
            <!--<span class="glow"></span>-->
            <a href="<?php echo base_url(); ?>index.php?accountant/report/" rel="tooltip" data-placement="right" 
               data-original-title="<?php /* ?><?php echo translate('invoice_help');?><?php */ ?>">
                <!--<i class="icon-money icon-1x"></i>-->
                <img src="<?php echo base_url(); ?>template/images/icons/payment.png" />
        ...
        <li class="<?php if ($page_name == 'income') echo 'dark-nav active'; ?>">
            <!--<span class="glow"></span>-->
            <a href="<?php echo base_url(); ?>index.php?accountant/income" rel="tooltip" data-placement="right" 
               data-original-title="<?php /* ?><?php echo translate('invoice_help');?><?php */ ?>">
                <!--<i class="icon-money icon-1x"></i>-->
                <img src="<?php echo base_url(); ?>template/images/icons/payment.png" />
        ...
        <li class="<?php if ($page_name == 'income_report') echo 'dark-nav active'; ?>">
            <!--<span class="glow"></span>-->
            <a href="<?php echo base_url(); ?>index.php?accountant/income_report/" rel="tooltip" data-placement="right" 
               data-original-title="<?php /* ?><?php echo translate('invoice_help');?><?php */ ?>">
                <!--<i class="icon-money icon-1x"></i>-->
                <img src="<?php echo base_url(); ?>template/images/icons/payment.png" />
        ...
        <li class="<?php if ($page_name == 'expense') echo 'dark-nav active'; ?>">
            <!--<span class="glow"></span>-->
            <a href="<?php echo base_url(); ?>index.php?accountant/expense" rel="tooltip" data-placement="right" 
               data-original-title="<?php /* ?><?php echo translate('invoice_help');?><?php */ ?>">
                <!--<i class="icon-money icon-1x"></i>-->
                <img src="<?php echo base_url(); ?>template/images/icons/payment.png" />
        ...
        <li class="<?php if ($page_name == 'expense_report') echo 'dark-nav active'; ?>">
            <!--<span class="glow"></span>-->
            <a href="<?php echo base_url(); ?>index.php?accountant/expense_report/" rel="tooltip" data-placement="right" 
               data-original-title="<?php /* ?><?php echo translate('invoice_help');?><?php */ ?>">
                <!--<i class="icon-money icon-1x"></i>-->
                <img src="<?php echo base_url(); ?>template/images/icons/payment.png" />
        ...
        <li class="<?php if ($page_name == 'book') echo 'dark-nav active'; ?>">
                <!--<span class="glow"></span>-->
            <a href="<?php echo base_url(); ?>index.php?accountant/book" rel="tooltip" data-placement="right" 
        ...
        <li class="<?php if ($page_name == 'transport') echo 'dark-nav active'; ?>">
                <!--<span class="glow"></span>-->
            <a href="<?php echo base_url(); ?>index.php?accountant/transport" rel="tooltip" data-placement="right" 
        ...
        <li class="<?php if ($page_name == 'dormitory') echo 'dark-nav active'; ?>">
                <!--<span class="glow"></span>-->
            <a href="<?php echo base_url(); ?>index.php?accountant/dormitory" rel="tooltip" data-placement="right" 
        ...
        <li class="<?php if ($page_name == 'noticeboard') echo 'dark-nav active'; ?>">
                <!--<span class="glow"></span>-->
            <a href="<?php echo base_url(); ?>index.php?accountant/noticeboard" rel="tooltip" data-placement="right" 
        ...
        <li class="<?php if ($page_name == 'system_settings') echo 'active'; ?>">
            <a href="<?php echo base_url(); ?>index.php?accountant/system_settings">
        ...
        <li class="<?php if ($page_name == 'fees_setup') echo 'active'; ?>">
            <a href="<?php echo base_url(); ?>index.php?accountant/fees_setup">
                          <!--<i class="icon-h-sign"></i>-->
                <img src="<?php echo base_url(); ?>template/images/icons/system_settings.png" />
        ...
        <li class="<?php if ($page_name == 'salary_setup') echo 'active'; ?>">
            <a href="<?php echo base_url(); ?>index.php?accountant/salary_setup">
                          <!--<i class="icon-h-sign"></i>-->
                <img src="<?php echo base_url(); ?>template/images/icons/system_settings.png" />
		...
		<li class="<?php if ($page_name == 'salary_genarate') echo 'active'; ?>">
            <a href="<?php echo base_url(); ?>index.php?accountant/salary_genarate">
                          <!--<i class="icon-h-sign"></i>-->
                <img src="<?php echo base_url(); ?>template/images/icons/system_settings.png" />
		...
		<li class="<?php if ($page_name == 'salary_status') echo 'active'; ?>">
            <a href="<?php echo base_url(); ?>index.php?accountant/salary_status">
                          <!--<i class="icon-h-sign"></i>-->
                <img src="<?php echo base_url(); ?>template/images/icons/system_settings.png" />
        ...
        <li class="<?php if ($page_name == 'salaryreport') echo 'dark-nav active'; ?>">
            <!--<span class="glow"></span>-->
            <a href="<?php echo base_url(); ?>index.php?accountant/salaryreport/" rel="tooltip" data-placement="right" 
               data-original-title="<?php /* ?><?php echo translate('invoice_help');?><?php */ ?>">
                <!--<i class="icon-money icon-1x"></i>-->
                <img src="<?php echo base_url(); ?>template/images/icons/payment.png" />
        ...
        <li class="<?php if ($page_name == 'manage_language') echo 'active'; ?>">
            <a href="<?php echo base_url(); ?>index.php?accountant/manage_language">
        ...
        <li class="<?php if ($page_name == 'manage_profile') echo 'dark-nav active'; ?>">
                <!--<span class="glow"></span>-->
            <a href="<?php echo base_url(); ?>index.php?accountant/manage_profile" rel="tooltip" data-placement="right" 
        ...
        <li class="<?php if ($page_name == 'backup_restore') echo 'dark-nav active'; ?>">
            <a href="<?php echo base_url(); ?>index.php?accountant/backup_restore">
