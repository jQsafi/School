		...
		<ul class="nav nav-tabs nav-tabs-left">
			<li class="active">
            	<a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> 
					<?php echo translate('book_list');?>
                    	</a></li>
			<li>
            	<a href="#add" data-toggle="tab"><i class="icon-plus"></i>
					<?php echo translate('add_book');?>
                    	</a></li>
		</ul>
    	<!------CONTROL TABS END------->
		...
		<div class="tab-content">
            ...
            <div class="tab-pane box active" id="list">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive box">
                	<thead>
                		<tr>
                    		<th><div>#</div></th>
                    		<th><div><?php echo translate('book_name');?></div></th>
                    		<th><div><?php echo translate('author');?></div></th>
                    		<th><div><?php echo translate('description');?></div></th>
                    		<th><div><?php echo translate('price');?></div></th>
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<?php
								if($row['class_id']) 
								echo $this->crud_model->get_type_name_by_id('class',$row['class_id']);
								else
								echo "All";
							?>
							</td>
							...
							<td align="center">
                            	...
                            	<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?accountant/book/delete/<?php echo $row['book_id'];?>')"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open('accountant/book/create' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                        <div class="padded">
                            ...
                            <div class="control-group">
                                <label class="control-label"><?php echo translate('author');?></label>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <label class="control-label"><?php echo translate('price');?></label>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select name="status" class="uniform" style="width:100%;">
                                    	...
                                    	<option value="unavailable"><?php echo translate('unavailable');?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="form-actions">
                            <button type="submit" class="btn btn-gray"><?php echo translate('add_book');?></button>
                        </div>
                    </form>                
                </div>                
			</div>
