...
<?php                
                ...
                if ($number_of_row >= 1) {
            ?>
			 <?php echo form_open('accountant/payslip/all',array('target'=>'_blank'));  ?>  
                    ...
                    <?php 
                        ...
                        foreach ($salaryreport as $row): ?>
                            <tr>
                                ...
                                <td href="<?php echo base_url();?>index.php?accountant/payslip/<?php echo $row['id'];?>" window="new" win_height="816px" win_width="1200px"><?php echo $serial_no; ?></td>								
                                <td href="<?php echo base_url();?>index.php?accountant/payslip/<?php echo $row['id'];?>" window="new" win_height="816px" win_width="1200px">
                                <?php
								...
								<td href="<?php echo base_url();?>index.php?accountant/payslip/<?php echo $row['id'];?>" window="new" win_height="816px" win_width="1200px"><?php echo $this->db->get_where('teacher', array('teacher_id' => $teacher_id))->row()->name; ?></td>								
								<td href="<?php echo base_url();?>index.php?accountant/payslip/<?php echo $row['id'];?>" window="new" win_height="816px" win_width="1200px">
                                <?php
								...
								<td>
								<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo site_url('accountant/salary_status/delete/'.$row['id']); ?>')" class="btn btn-red btn-small">
