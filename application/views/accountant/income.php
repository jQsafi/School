        ...
        <div class="tab-content">
                        ...
                        foreach ($incomes as $row):
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url(); ?>index.php?accountant/income/delete/<?php echo $row['inc_id']; ?>')" class="btn btn-red btn-small">
            ...
            <div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('accountant/income/create', array('class' => 'form-horizontal validatable', 'enctype' => 'multipart/form-data')); ?>
                    <div class="padded">
