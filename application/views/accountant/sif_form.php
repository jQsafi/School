            ...
            <ul class="nav nav-tabs nav-tabs-left">
                    <li class="active" >
                        <a href="#add" data-toggle="tab"><i class="icon-plus"></i>
                            <?php echo translate('sif_form','upper_case'); ?>
                        </a>
                    </li>
            </ul>
            <!------CONTROL TABS END------->
                ...
                <div class="tab-pane box add-student-container active " id="add" style="padding: 5px">
                    <?php if ($total_student <= $maximum) { ?>
                        <div class="box-content">
                            <?php echo form_open('accountant/student_add/create/', array('class' => 'form-horizontal validatable', 'enctype' => 'multipart/form-data')); ?>
                            <div class="padded"> 
								...
								<div class="control-group">
									...
									<?php echo translate('ID','upper_case'); ?>
									</label>
									<div class="controls">
                                        <input type="text" class="" name="student_unique_ID" placeholder="" maxlength="7" value="" id="student_unique_ID"/>
                                    </div>
								</div>
								<div class="control-group">
                                ...
                                <div class="control-group">
								 ...
								 <div class="control-group custom-block">
                                    ...
                                    <div class="uk-panel uk-margin-top">
                                        <input type="text" class="w300" name="father_name" placeholder="Enter Name(English)"/>
										<input type="text" class="w300" name="father_name_bangla" placeholder="Enter Name(Bangla)"/>
										</div>
										<div class="uk-panel uk-margin-top">
                                ...
                                <div class="control-group custom-block">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="text" class="" name="others_roll" placeholder="Enter roll no"/>  
										 <input type="text" class="" name="others_id" placeholder="Enter ID no"/>  
                                    </div>
                                </div>
