<div class="tab-pane box active edit-student-container" id="edit" style="padding: 5px">
    <div class="box-content">
        <?php foreach ($edit_data as $row): ?>
            <?php echo form_open('accountant/expense/do_update/' . $row['exp_id'], array('class' => 'form-horizontal validatable', 'target' => '_parent', 'enctype' => 'multipart/form-data')); ?>
            ...
            <div class="padded">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" class="datepicker fill-up" name="expense_date" value="<?php echo date('d-m-Y',$row['expense_timestamp']); ?>" required=""/>
                    </div>
                </div>
                <div class="control-group">
