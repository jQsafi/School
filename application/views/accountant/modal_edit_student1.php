<div class="tab-pane box active edit-student-container" id="edit" style="padding: 5px">
    <div class="box-content">
        <?php foreach ($edit_data as $row): ?>
            <?php echo form_open('accountant/student/' . $class_id . '/do_update/' . $row['student_id'], array('class' => 'form-horizontal validatable', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
            <div class="padded">
                ...
                <h3><label style="display: inline-block; font-size: 20px; font-weight: 600;" for="admission_type_re">Re admission information in this institution-</label></h3>
                <div class="control-group custom-block">                                    
