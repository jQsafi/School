        ...
        <div class="tab-content">
                        ...
                        foreach ($expenses as $row):
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url(); ?>index.php?accountant/expense/delete/<?php echo $row['exp_id']; ?>')" class="btn btn-red btn-small">
            ...
            <div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('accountant/expense/create', array('class' => 'form-horizontal validatable', 'enctype' => 'multipart/form-data')); ?>
                    <div class="padded">
