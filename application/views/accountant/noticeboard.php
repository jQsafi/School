		...
		<ul class="nav nav-tabs nav-tabs-left">
			...
			<li>
            	<a href="#add" data-toggle="tab"><i class="icon-plus"></i>
					<?php echo translate('add_noticeboard');?>
                    	</a></li>
		</ul>
    	<!------CONTROL TABS END------->
		...
		<div class="tab-content">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?accountant/noticeboard/delete/<?php echo $row['notice_id'];?>')" class="btn btn-red btn-small">
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open('accountant/noticeboard/create' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                                ...
                                <div class="controls">
                                    <div class="box closable-chat-box">
                                        <div class="box-content padded">
                                                ...
                                                <textarea name="notice" id="ttt" rows="5" placeholder="<?php echo translate('add_notice');?>"></textarea>
                                                </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-blue"><?php echo translate('add_noticeboard');?></button>
                        </div>
                    </form>                
                </div>                
			</div>
