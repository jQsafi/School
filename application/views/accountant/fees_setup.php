    ...
    <div class="box-content padded">
        <div class="tab-content">
            ...
            <div class="tab-pane box" id="fees_setup" style="padding: 5px">
                <div class="box-content">
                    <!-- <form action="http://localhost/school-management-system/index.php?/accountant/fees_setup/monthly_fees/do_update" method="post" accept-charset="utf-8" class="form-horizontal validatable" target="_top">-->
                    <?php echo form_open('accountant/fees_setup/set_fees', array('class' => 'form-horizontal validatable', 'target' => '_top')); ?>    
                    <div class="padded">
            ...
            <div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('accountant/fees_setup/create', array('class' => 'form-horizontal validatable')); ?>    
                    <div class="padded">                        
                        <div class="control-group">
...
<script type="text/javascript">    
    $("select.classID").on("change", function(event) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url(); ?>/index.php?accountant/fees_setup/set_fees_by_class/"+class_id,
            dataType: "html",
