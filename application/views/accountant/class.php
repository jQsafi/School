		...
		<div class="tab-content">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?accountant/classes/delete/<?php echo $row['class_id'];?>')" class="btn btn-red btn-small">
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open('accountant/classes/create' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                        <div class="padded">
