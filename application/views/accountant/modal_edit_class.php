<div class="tab-pane box active" id="edit" style="padding: 5px">
    <div class="box-content">
        ...
        <?php echo form_open('accountant/classes/do_update/'.$row['class_id'] , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
            <div class="padded">
                ...
                <div class="control-group">
                    <label class="control-label"><?php echo translate('numeric_name');?></label>
                    <div class="controls">
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-gray"><?php echo translate('edit_class');?></button>
            </div>
        </form>
        <?php endforeach;?>
    </div>
