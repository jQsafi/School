                                                      ...
                                                      <div class="btn-group action-dropdown">
                                                       ...
                                                       Action
														...
														if ($this->session->userdata('user_role') != 'accountant/') { ?>
                                                            ...
                                                            <li> <a  data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url(); ?>index.php?accountant/student/<?php echo $class_id; ?>/delete/<?php echo $row['student_id']; ?>')" class="">
