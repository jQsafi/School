	...
	<div class="box-content padded">
		<div class="tab-content">
					...
					foreach($classes as $row):
						?>
                            <div class="accordion-group">
								...
								<div>
								<a style="margin-top: -35px;float:right;" href="<?php echo base_url(); ?>index.php?accountant/routineprint/<?php echo $row['class_id']; ?>" class="btn btn-gray" rel="tooltip" data-placement="right" 
                                                    ...
                                                    <td>
														...
														<div class="btn-group">
															...
															<ul class="dropdown-menu">
																...
																<li><a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?accountant/class_routine/delete/<?php echo $row2['class_routine_id'];?>')">
            ...
            <!----TABLE LISTING ENDS--->
			 ...
			 <div>  <a style="margin-top: -8px;float:center;" href="<?php echo base_url(); ?>index.php?accountant/routineprint/all" class="btn btn-gray" rel="tooltip" data-placement="right" 
			   data-original-title="" window="new" win_height="816px" win_width="1200px">
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open('accountant/class_routine/create' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
