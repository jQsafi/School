<div class="tab-pane box active" id="edit" style="padding: 5px">
    <div class="box-content">
        ...
        <?php echo form_open('accountant/book/do_update/'.$row['book_id'] , array('class' => 'form-horizontal validatable','target'=>'_parent'));?>
            <div class="padded">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="status" class="uniform" style="width:100%;">
                            <option value="available" <?php if($row['status']=='available')echo 'selected';?>><?php echo translate('available');?></option>
                            <option value="unavailable" <?php if($row['status']=='unavailable')echo 'selected';?>><?php echo translate('unavailable');?></option>
                        </select>
                    </div>
                </div>
            </div>
            <div class="form-actions">
                <button type="submit" class="btn btn-gray"><?php echo translate('edit_book');?></button>
            </div>
        </form>
        <?php endforeach;?>
    </div>
