<?php
	...
	$this->set_css($this->default_theme_path.'/school/css/demo_table_jui.css');
	$this->set_css($this->default_css_path.'/ui/simple/'.grocery_CRUD::JQUERY_UI_CSS);
	$this->set_css($this->default_theme_path.'/school/css/datatables.css');
	$this->set_css($this->default_theme_path.'/school/css/jquery.dataTables.css');
	$this->set_css($this->default_theme_path.'/school/extras/TableTools/media/css/TableTools.css');
	...
	$this->set_js_lib($this->default_theme_path.'/school/js/jquery.dataTables.min.js');
	$this->set_js($this->default_theme_path.'/school/js/datatables-extras.js');
