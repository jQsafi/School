...
!function( $ ) {
 ...
 "use strict";
  ...
  template: '<div class="combobox-container"><input type="hidden"><input type="text" autocomplete="off" class="span4" /><span class="add-on btn dropdown-toggle" data-dropdown="dropdown"><span class="caret"></span><span class="combobox-clear"><i class="icon-remove"/></span></span></div>'
